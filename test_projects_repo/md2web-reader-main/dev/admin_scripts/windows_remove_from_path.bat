...
echo ========================================================
echo md2web Reader - Remove Project Root from Windows User PATH
echo ========================================================
echo.

set "SCRIPT_DIR=%~dp0"
set "PS_SCRIPT=%SCRIPT_DIR%windows_remove_from_path.ps1"
...
if %errorlevel% neq 0 (
    echo.
    echo [ERROR] Failed to execute PATH removal script.
)
